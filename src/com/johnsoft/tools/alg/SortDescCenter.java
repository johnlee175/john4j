...
//		insertSortDesc(a, a.length);
//		selectSortDesc(a, a.length);
...
//		mergeSortDesc(a, a.length);
	...
	public static final void bubbleSortDesc(int[] arr, int len)
	{
		for (int i = 0; i < len; ++i)
		{
	...
	public static final void insertSortDesc(int[] arr, int len)
	{
		for (int i = 0; i < len; ++i)
		{
			for (int j = i; j > 0; --j)
	...
	public static final void selectSortDesc(int[] arr, int len)
	{
		for(int i = 0; i < len; ++i)
		{
			int m = i;
	...
	public static final void mergeSortDesc(int[] arr, int len)
	{
		split(arr, 0, len - 1);
	}
