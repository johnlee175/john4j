...
//				pane.repaint(x,y,w,h);
	...
	{
		return JohnActiveHeaderRenderer.installRowHeader(table, null, 25);
	}
	...
	public static Font createNewFont(String ttfFilePath,int fontStyle,int fontSize)
	{
		...
		{
			JohnException.showException(e, "字体文件加载失败", null, null);
			return null;
		} 
	}
	...
	/**
	 * 此方法用于以二维数组为蓝图创建菜单条
	 * @param arr 菜单label的二维数组
	 * @return 菜单栏
	 */
	public static JMenuBar getTheMenuBar(String[][] arr)
	{
