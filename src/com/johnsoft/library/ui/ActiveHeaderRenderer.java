package com.johnsoft.library.ui;
 ...
 * @author 李哲浩
 */
public class ActiveHeaderRenderer implements TableCellRenderer, MouseMotionListener, MouseListener
{
	...
	public static JScrollPane installRowHeader(JTable table,C<JTable> rowHeaderColumnTableRef,int fitRowHeight)
	{
		...
		new ActiveHeaderRenderer(dcHeader,table,fitRowHeight+5);
		new ActiveHeaderRenderer(rhHeader,table,fitRowHeight+5);
		new ActiveHeaderRenderer(rowHeaderColumn,table, 0);
	 ...
	 */
	public ActiveHeaderRenderer(JTableHeader colHeader,JTable dataTable,int colHeaderHeight)
	{
	 ...
	 */
	public ActiveHeaderRenderer(JTable rowHeader,JTable dataTable,int rowHeaderColIdx)
	{
