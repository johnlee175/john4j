 ...
 */
public class JohnDateChooser extends JPanel
{
	...
	// 获取实例与构造方法开始
	public JohnDateChooser()
	{
		this(new Date());
	}

	public JohnDateChooser(Date date)
	{
		this(date, false);
	}

	public JohnDateChooser(boolean isChina)
	{
		this(new Date(), isChina);
	}

	public JohnDateChooser(String format)
	{
		this(new Date(), format);
	}

	public JohnDateChooser(Date date, boolean isChina)
	{
		this(date, "yyyy-MM-dd HH:mm:ss", isChina);
	}

	public JohnDateChooser(String format, boolean isChina)
	{
		this(new Date(), format, isChina);
	}

	public JohnDateChooser(Date date, String format)
	{
		this(date, format, false);
	}

	public JohnDateChooser(Date date, String format, boolean isChina)
	{
	 ...
	 *            中文还是英文
	 */
	public void register(final JComponent dateField, Window win,
	...
	protected class JHeadPane extends JPanel
	{
		...
		private void initJHeadPane()
		{
			yearLab = new JLabel();
			monthLab = new JLabel();
			container = new JLabel();
			
			YearSpinner spinYear = new YearSpinner(yearLab,
					dateModel.getYearList(), dateModel.getSelectedYear());
			MonthSpinner spinMonth = new MonthSpinner(monthLab,
