...
public class JohnFilteredModel extends AbstractListModel implements
		DocumentListener
{
	...
	protected JohnFilteredList owner = null;

	public JohnFilteredModel()
	{
		this(null);

	}

	public JohnFilteredModel(JohnFilteredList father)
	{
		this.owner = father;
