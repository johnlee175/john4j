package com.johnsoft.library.swing.component.expandpane;
...
public class JohnExpandingAdapter extends MouseAdapter
{
    ActionPanel[] aps;
    JPanel[] panels;
 
    public JohnExpandingAdapter()
    {
...
//    {
//        JohnExpandingAdapter test = new JohnExpandingAdapter();
//        JFrame f = new JFrame();
