...
/**
 * The panel is use for show something loading indeterminately
 * 
 * @author john
 * 
 */
public class JohnAnimatePanel extends JPanel
{
	...
	/**
	 * @param message	which message will show
	 * @param icon	which picture will show
	 */
	public JohnAnimatePanel(String message, ImageIcon icon)
	{
	...
	public Dimension getPreferredSize()
	{
		...
		return new Dimension(originalImage.getWidth() + 12,
				(int) (originalImage.getHeight() + bounds.getHeight()
						+ layout.getAscent() + 12));
	}
	...
	public void paintComponent(Graphics g)
	{
		...
		if (convolvedImage != null)
		{
			...
			synchronized (convolvedImage)
			{
				...
				int y = (int) (height - (convolvedImage.getHeight(null)
						+ bounds.getHeight() + layout.getAscent())) / 2;
				...
				layout.draw(
						...
						(float) (y + convolvedImage.getHeight(null)
	...
	/**
	 * Change the shine of the picture 
	 */
