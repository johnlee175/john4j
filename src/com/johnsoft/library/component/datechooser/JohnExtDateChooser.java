...
import com.johnsoft.library.util.JohnSimpleHelper;
...
public class JohnExtDateChooser extends JohnDateChooser
{
	...
	{
		if(JohnStringUtil.isUnemptyAndUnEqual(text1, new String[]{defaultText})&&JohnSimpleHelper.isDate(pattern, text1))
		{
			if(JohnStringUtil.isUnemptyAndUnEqual(text2, new String[]{defaultText})&&JohnSimpleHelper.isDate(pattern, text2))
			{
				if(!JohnSimpleHelper.isTimeOfFirstItemLower(pattern, text1, text2))
				{
